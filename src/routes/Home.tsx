    ...
    <div className="space-y-6 page-enter">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <div className="glass-card-hover p-5">
          ...
          <div className="mt-4">
            <Link className="inline-block px-5 py-2.5 btn-primary text-sm" to="/login" state={{ from: '/practice/words' }}>{t('home.startPractice')}</Link>
          </div>
        </div>
        ...
        <div className="glass-card-hover p-5">
          ...
          <div className="mt-4">
            <Link className="inline-block px-5 py-2.5 bg-gradient-green text-white rounded-xl font-medium transition-all duration-300 hover:shadow-lg hover:shadow-green-500/25 hover:-translate-y-0.5 text-sm" to="/login" state={{ from: '/practice/articles' }}>{t('home.enterArticlePractice')}</Link>
          </div>
        </div>
        ...
        <div className="glass-card-hover p-5">
          ...
          <div className="mt-4 flex gap-2 flex-wrap">
            <Link className="px-4 py-2 bg-gradient-to-r from-amber-500 to-amber-600 text-white rounded-xl text-sm font-medium transition-all duration-300 hover:shadow-lg hover:shadow-amber-500/25 hover:-translate-y-0.5" to="/login" state={{ from: '/collections' }}>{t('home.collections')}</Link>
            <Link className="px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl text-sm font-medium transition-all duration-300 hover:shadow-lg hover:shadow-red-500/25 hover:-translate-y-0.5" to="/login" state={{ from: '/wrong-words' }}>{t('home.wrongWords')}</Link>
            <Link className="px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl text-sm font-medium transition-all duration-300 hover:shadow-lg hover:shadow-green-500/25 hover:-translate-y-0.5" to="/login" state={{ from: '/mastered' }}>{t('home.mastered')}</Link>
          </div>
        </div>
      </div>
      ...
      <div className="glass-card p-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <Link to="/login" state={{ from: '/panel' }} className="flex items-center gap-3 p-3 rounded-xl border border-gray-200/60 dark:border-gray-700/40 hover:bg-gray-50/80 dark:hover:bg-gray-700/30 transition-all duration-200 hover:border-purple-200 dark:hover:border-purple-800 hover:shadow-sm group">
